...
// Keyboard input.
LPAAPI b8 input_is_key_down(keys key);
LPAAPI b8 input_is_key_up(keys key);
LPAAPI b8 input_was_key_down(keys key);
LPAAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// Mouse input.
LPAAPI b8 input_is_button_down(buttons button);
LPAAPI b8 input_is_button_up(buttons button);
LPAAPI b8 input_was_button_down(buttons button);
LPAAPI b8 input_was_button_up(buttons button);
LPAAPI void input_get_mouse_position(i32* x, i32* y);
LPAAPI void input_get_previous_mouse_position(i32* x, i32* y);
