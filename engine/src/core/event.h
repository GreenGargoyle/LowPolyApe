 ...
 */
LPAAPI b8 event_register(u16 code, void* listener, PFN_on_event on_event);
 ...
 */
LPAAPI b8 event_unregister(u16 code, void* listener, PFN_on_event on_event);
 ...
 */
LPAAPI b8 event_fire(u16 code, void* sender, event_context context);
