...
b8 vulkan_create_device(vulkan_context* context)
{
    ...
    LPAINFO("Creating logical device...");
    ...
    LPAINFO("Logical device created.");
...
void vulkan_device_destroy(vulkan_context* context)
{
    ...
    LPAINFO("Destroying logical device...");
    ...
    LPAINFO("Releasing physical device resources...");
    ...
    lpazero_memory(&context->device.swapchain_support.capabilities, sizeof(context->device.swapchain_support.capabilities));
