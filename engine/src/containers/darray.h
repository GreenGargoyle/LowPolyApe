...
LPAAPI void* _darray_create(u64 length, u64 stride);
LPAAPI void _darray_destroy(void* array);

LPAAPI u64 _darray_field_get(void* array, u64 field);
LPAAPI void _darray_field_set(void* array, u64 field, u64 value);

LPAAPI void* _darray_resize(void* array);

LPAAPI void* _darray_push(void* array, const void* value_ptr);
LPAAPI void _darray_pop(void* array, void* dest);

LPAAPI void* _darray_pop_at(void* array, u64 index, void* dest);
LPAAPI void* _darray_insert_at(void* array, u64 index, void* value_ptr);
...
// for VSCode flags is an unknown type. typeof() seems to 
// work fine though. Both are GNU extensions.
